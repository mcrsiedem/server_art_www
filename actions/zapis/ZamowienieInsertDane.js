...
const zamowienieInsertDane = (req,res) =>{
  ...
  // procesyElementow = procesyElementow.map((obj) => {return{...obj, zamowienie_id:result.insertId} })
    var sql =   "INSERT INTO artdruk.zamowienia (nr,rok,firma_id,klient_id,tytul,data_przyjecia,data_materialow,data_spedycji,opiekun_id,utworzyl_user_id,stan,status,uwagi,etap,waluta_id,vat_id,przedplata,cena,termin_platnosci,fsc,nr_stary,kod_pracy,nr_zamowienia_klienta,isbn) "+
    "values ('" + daneZamowienia.nr + "','" + daneZamowienia.rok + "','" + daneZamowienia.firma_id+ "','" + daneZamowienia.klient_id + "','" + daneZamowienia.tytul + "'," + ifNoDateSetNull(daneZamowienia.data_przyjecia) + "," +ifNoDateSetNull(daneZamowienia.data_materialow)  + "," + ifNoDateSetNull(daneZamowienia.data_spedycji) + ",'" + daneZamowienia.opiekun_id + "','" + daneZamowienia.user + "'," + daneZamowienia.stan + "," + daneZamowienia.status + ",'" + daneZamowienia.uwagi + "'," + daneZamowienia.etap + ",'" + daneZamowienia.waluta_id + "','" + daneZamowienia.vat_id + "','" + daneZamowienia.przedplata + "','" + daneZamowienia.cena + "','" + daneZamowienia.termin_platnosci + "','" + daneZamowienia.fsc + "','" + daneZamowienia.nr_stary + "','" + daneZamowienia.kod_pracy + "','" + daneZamowienia.nr_zamowienia_klienta + "','" + daneZamowienia.isbn + "'); ";
