...
const zapiszTechnologieInsertGrupyHarmonogram = (req,res) =>{
...
var sql =
"INSERT INTO artdruk.technologie_grupy_wykonan(poczatek,id,indeks,technologia_id,zamowienie_id,mnoznik,czas,koniec,narzad,nazwa,predkosc,proces_id,procesor_id,element_id,przeloty,status,stan,typ_grupy,uwagi) " +
" " +
poczatek +  ",'" +
grupa.id +  "','" +
grupa.indeks +        "','" +
...
module.exports = {
  zapiszTechnologieInsertGrupyHarmonogram
