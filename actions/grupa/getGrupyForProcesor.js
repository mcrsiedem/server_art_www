...
const getGrupyForProcesor = async (req, res) => {
            ...
            // ProcesyView - używane w momencie zmiany procesora  
             ...
             var sql = "select * from artdruk.view_technologie_grupy_wykonan where poczatek >  (select min(poczatek) - interval 1 day from artdruk.view_technologie_grupy_wykonan where status <4 and procesor_id = ?)  and procesor_id = ? ORDER BY poczatek";
